...
# def a_star_search(problem, heuristic=null_heuristic):
#     return a_star_masha(problem, util.PriorityQueue(), heuristic)
#
#
# def a_star_masha(problem, fringe, heuristic=null_heuristic):
#     start_state = problem.get_start_state()
#     start_node = Node(start_state, [], None, 0, heuristic(start_state, problem))
...
#             successor_node = Node(successor_state, current_node.actions + [action], current_node, successor_cost, heuristic_cost)
#             fringe.push(successor_node) if not isinstance(fringe, util.PriorityQueue) else \
#                 (fringe.push(successor_node, successor_cost + heuristic_cost))
#
#     return []
